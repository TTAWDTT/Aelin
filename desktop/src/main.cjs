...
function startBackend() {
  ...
  const env = {
    ...
    MERCURYDESK_BROWSER_TOOL_HEADLESS: "0",
    MERCURYDESK_BROWSER_TOOL_OPEN_EXTERNAL_ON_NAVIGATE: "1",
    MERCURYDESK_BROWSER_TOOL_MODE_DEFAULT: "auto",
    MERCURYDESK_BROWSER_TOOL_CDP_ENABLED: "1",
    MERCURYDESK_BROWSER_TOOL_CDP_ENDPOINT: "http://127.0.0.1:9222",
  };
